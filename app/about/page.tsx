...
export default function AboutPage() {
  return (
    <PolicyPage eyebrow="ABOUT GOLDENGAMES" title="Independent coverage for curious players." intro="GoldenGames Nexus follows the console scene with a focus on clear explanations, responsible experimentation and practical information.">
      <section><h2>What we cover</h2><p>Our coverage includes PS5, PS4, Xbox, Nintendo Switch and retro gaming, with news about homebrew applications, scene developments, preservation projects, compatibility updates and community tools.</p></section>
