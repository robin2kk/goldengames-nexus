...
import { assertCommunityOrigin, createCommunitySession, sessionCookie, verifyPassword } from "../../../community-auth";
...
export async function POST(request: Request) {
  ...
  const input = await request.json().catch(() => ({})) as { identity?: string; password?: string };
