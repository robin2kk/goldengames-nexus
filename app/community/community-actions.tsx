...
export function NewPostForm() {
  ...
  return <form className="community-form" onSubmit={submit}>
    ...
    <div className="community-field-row"><label>Platform<select name="platform" defaultValue="PS5"><option>PS5</option><option>PS4</option><option>PS3</option><option>Xbox</option><option>Switch</option><option>Retro</option><option>General</option></select></label><label>Post type<select name="kind"><option>Question</option><option>Discussion</option></select></label></div>
