...
export default function PrivacyPage() {
  return (
    <PolicyPage eyebrow="PRIVACY" title="How visitor information is handled." intro="GoldenGames Nexus is designed to collect as little personal information as reasonably possible while operating a secure publishing website.">
      ...
      <section><h2>Security and abuse prevention</h2><p>Community registration and sign-in may use Cloudflare Turnstile to distinguish legitimate visitors from automated abuse. Cloudflare may process limited device, browser and network information for this security check according to its privacy terms.</p></section>
